window.APP_CONFIG = {
  ...
  // ERC20: decimals/approve/balanceOf (พอสำหรับ DApp นี้)
  ERC20_ABI: [
  ...
  // VaultV6: claimable/earns/claim/refresh
  VAULT_ABI: [
  ...
  BINARY_ABI: [
    {
      ...
      "name":"addVolume","outputs":[],"stateMutability":"nonpayable","type":"function"
    },
    {
